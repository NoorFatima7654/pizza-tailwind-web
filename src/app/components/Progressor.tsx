  ...
  return (
    ...
    <div className=" flex items-start max-w-screen-lg w-full mx-auto mt-10">
      ...
      <div>
        ...
        <p className="text-xs text-white">Explore our delicious menu and select your </p>
    </div>
    </div>
    ...
    <div className="w-full">
      ...
      <div>
        <h6 className="text-base font-bold text-amber-500">Step 2:  Customise your Order</h6>
        <p className="text-xs text-white">Explore our delicious menu and select your </p>
    </div>
    </div>
